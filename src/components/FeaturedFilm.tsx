    ...
    <section id="featured-film-section" className="py-8 bg-white text-neutral-900 relative overflow-hidden border-b border-neutral-100">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        <div className="text-center max-w-2xl mx-auto mb-12">
          <span className="inline-flex items-center gap-1.5 text-xs font-bold uppercase tracking-[0.2em] text-brand-gradient mb-2 font-sans">
            <Film className="w-3.5 h-3.5 text-brand-gradient" /> Watch Our Masterpieces
          </span>
