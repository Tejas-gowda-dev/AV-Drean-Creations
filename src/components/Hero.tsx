  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-8 pointer-events-none hidden md:block rounded-2xl z-10"></div>
      </div>
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 md:px-6 pb-10 md:pb-14 text-center text-white">
        ...
        >
          ...
          <p className="font-sans text-neutral-200 max-w-3xl mx-auto text-[10px] sm:text-xs md:text-sm font-medium tracking-[0.2em] leading-relaxed uppercase">
