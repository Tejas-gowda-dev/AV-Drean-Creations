  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none opacity-30">
        <div className="absolute top-0 left-1/4 w-[1px] h-full bg-gradient-to-b from-brand-purple/10 via-brand-primary/5 to-transparent"></div>
        <div className="absolute top-0 left-2/4 w-[1px] h-full bg-gradient-to-b from-transparent via-brand-primary/5 to-transparent"></div>
        <div className="absolute top-0 left-3/4 w-[1px] h-full bg-gradient-to-b from-transparent via-brand-primary/10 to-transparent"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="text-center max-w-xl mx-auto mb-16 space-y-3">
          ...
          <h2 className="font-serif text-3xl sm:text-4xl font-normal text-neutral-900 tracking-tight">
            The Trust Behind Your <span className="italic font-light ">Timeless Stories</span>
          </h2>
